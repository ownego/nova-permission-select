...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-permission-select', __webpack_require__(3));
  Vue.component('detail-permission-select', __webpack_require__(6));
  Vue.component('form-permission-select', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    calculateRatio: function calculateRatio(action) {
      var permissions = _(this.field.permissions).filter(function (p) {
        return p.name.includes(action);
      }).value();
      var selectedPermissions = _(this.field.value).filter(function (p) {
        return p.name.includes(action);
      }).value();
...
var render = function() {
  ...
  return _c("div", [
    _c("span", { staticClass: "p-1", attrs: { title: "Create" } }, [
      _c("span", {
        staticClass: "inline-block rounded-full w-2 h-2",
        class: _vm.getClass(_vm.calculateRatio("create"))
      })
    ]),
    _vm._v(" "),
    _c("span", { staticClass: "p-1", attrs: { title: "View" } }, [
      _c("span", {
        staticClass: "inline-block rounded-full w-2 h-2",
        class: _vm.getClass(_vm.calculateRatio("view"))
      })
    ]),
    _vm._v(" "),
    _c("span", { staticClass: "p-1", attrs: { title: "Edit" } }, [
      _c("span", {
        staticClass: "inline-block rounded-full w-2 h-2",
        class: _vm.getClass(_vm.calculateRatio("edit"))
      })
    ]),
    _vm._v(" "),
    _c("span", { staticClass: "p-1", attrs: { title: "Delete" } }, [
      _c("span", {
        staticClass: "inline-block rounded-full w-2 h-2",
        class: _vm.getClass(_vm.calculateRatio("delete"))
      })
    ])
  ])
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    var permissions = _(this.field.permissions);

    this.value = permissions.map(function (permission) {
      var spaceIndex = permission.name.indexOf(' ');
      name = permission.name.substring(spaceIndex + 1);

      return {
        name: name
      };
    }).uniqBy('name').map(function (resource) {
      var children = permissions.filter(function (permission) {
        var spaceIndex = permission.name.indexOf(' ');
        name = permission.name.substring(spaceIndex + 1);
        ...
        var selectedPermission = _(_this.field.value).find(function (v) {
      ...
      _c("template", { slot: "value" }, [
        _c(
          ...
          _vm._l(_vm.value, function(group) {
            return _c("li", { key: group.name, staticClass: "mt-2" }, [
              _c("label", [_c("b", [_vm._v(_vm._s(group.name))])]),
              _vm._v(" "),
              _c(
                "ul",
                { staticClass: "list-none ml-6" },
                _vm._l(group.children, function(child) {
                  return _c("li", { key: child.name, staticClass: "mt-2" }, [
                    _c(
                      "span",
                      {
                        staticClass: "inline-flex items-center py-1 pl-2 pr-3"
                      },
                      [
                        _c("boolean-icon", {
                          attrs: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setInitialValue: function setInitialValue() {
      ...
      this.value = permissions.map(function (permission) {
        ...
        var children = permissions.filter(function (permission) {
          ...
          var name = permission.name.split(' ')[0];
          var selectedPermission = _(_this.value).find(function (v) {
            return v.name === permission.name;
          });
    ...
    fill: function fill(formData) {
      var selectedPermissions = _(this.value).flatMap(function (_ref) {
        var name = _ref.name,
            children = _ref.children;

        return children;
      }).filter('checked').map('value').value();

      formData.append(this.field.attribute, JSON.stringify(selectedPermissions));
    },
    toggle: function toggle(event, group, child) {
      var selectedGroup = _(this.value).find(function (g) {
        return g.name === group.name;
      });
      var selectedChild = _(selectedGroup.children).find(function (c) {
            ...
            return _c("li", { key: group.name, staticClass: "mt-2" }, [
              ...
              _c(
                ...
                _vm._l(group.children, function(child) {
                  return _c(
                    "li",
                    { key: child.name, staticClass: "mt-2" },
                    [
                      _c(
                        "checkbox-with-label",
                        {
                          attrs: { name: child.name, checked: child.checked },
                          on: {
                            input: function($event) {
                              return _vm.toggle($event, group, child)
                            }
                          }
                        },
                        [
